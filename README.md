...
| [FinanceDemo](Samples/MetabindAI/FinanceDemo) | A `MetabindAI` finance app with no chat in it — every screen is a rendered answer, routed to custom surfaces instead of a transcript. |
